...
task_json="./model/task_mix.json"
stop_words_en = set(stopwords.words('english'))
stop_words_cn = set([line.strip() for line in open('./model/stopwords_zn/cn_stopwords.txt',encoding='UTF-8').readlines()])
...
model.save("./model/task_model_mix.h5")
pickle.dump(vectorizer, open("./model/feature_mix.pickle", "wb"))
