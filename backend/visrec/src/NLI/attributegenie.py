...
class AttributeGenie:
    ...
    def detect_attributes_by_synonymity(self, query_ngrams, data_attributes, query_attributes):
        ...
        for attr in data_attributes:
            ...
            for ngram in query_ngrams:
                ...
                synonym_match_score_c = helpers.synonymity_score(query_ngrams[ngram]["lower"], data_attributes[attr]["lower"])
    ...
    def extract_attributes(self, query_ngrams,attributemap):
        """
        ...
        data_attributes=attributemap
        # map of attributes and their variants - stemmed, lowercase, ...
        attribute_aliases = self.get_attribute_aliases()
        # print("query_ngrams:",query_ngrams)
        # print("data_attributes:",data_attributes)
        # print("query_attributes",query_attributes)
        ...
        # print("query_attributes:",query_attributes)
        return query_attributes.keys()




        """Compute other info about attribute """
        # ---------------------------------------------------------------------------------------------------
